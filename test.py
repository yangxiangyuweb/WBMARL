...
def predict(convlstm_model_path,wavelength_actor_model_path,bandwidth_actor_model_path,filepath):

    # band_actor.load_state_dict(torch.load('../train/pth_save/sky/band90.pth'))
    # width_actor.load_state_dict(torch.load('../train/pth_save/sky/width90.pth'))
